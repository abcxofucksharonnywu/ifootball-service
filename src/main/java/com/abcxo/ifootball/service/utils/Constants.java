...
public class Constants {
    ...
    public static final String UPLOAD_HOST = "http://cdn.iamthefootball.com";
    ...
    public static final String TWEET_ADD_HTML = "<!DOCTYPE html><html><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"initial-scale=1,maximum-scale=1,minimum-scale=1,user-scalable=no\"><title></title><style type=\"text/css\">img{width:100%;object-fit:cover}.prompt{color:#319AFF}</style><script type=\"text/javascript\">function load(){for(var n=document.getElementsByTagName(\"img\"),t=0;t<n.length;t++)!function(t){var e=n[t];e.onclick=function(){handler.onImageClick(e.src)}}(t);for(var e=document.getElementsByClassName(\"prompt\"),o=0;o<e.length;o++)!function(n){var t=e[n];t.onclick=function(){handler.onPromptClick(t.textContent)}}(o)}</script></head><body onload=\"load()\"><div class=\"content\" style=\"margin-bottom:1rem\">#content#</div>#images#</body></html>";
