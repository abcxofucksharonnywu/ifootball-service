...
public class Constants {
    ...
    public static final String TWEET_ADD_HTML = "<!DOCTYPE html><html><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"initial-scale=1,maximum-scale=1,minimum-scale=1,user-scalable=no\"><title></title><style type=\"text/css\">img{width:100%;object-fit: cover;}</style><script type=\"text/javascript\">function load(){for(var n=document.getElementsByTagName(\"img\"),e=0;e<n.length;e++)!function(e){var t=n[e];t.height=10*t.width/16,t.onclick=function(){handler.onImageClick(t.src)}}(e)}</script></head><body onload=\"load()\"><div style=\"margin-bottom:1rem\">#content#</div>#images#</body></html>";
